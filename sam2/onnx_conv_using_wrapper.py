...
try:
    ...
    from utils.misc import load_video_frames_from_jpg_images
...
sam2_checkpoint = f"/home/maticd/matic/sam2_onnx_export/checkpoints/sam2.1_hiera_{model_size}.pt"
model_cfg = f"configs/sam2.1/sam2.1_hiera_{model_size[0]}.yaml"
video_dir = "/home/maticd/matic/sam2_onnx_export/assets/front0"
...
class ONNXWrapper(torch.nn.Module):
    ...
    def forward(self, images):
        inference_state = self.predictor.init_state(None, images)
        ...
        inference_state_2, _, out_obj_ids, out_mask_logits = self.predictor.add_new_points_or_box(
            ...
            frame_idx=0,
            obj_id=1,
            points= np.array([[10, 10]], dtype=np.float32), # [10,10] is the original (x,y) point given to the onnx model            
